...
ESX.RegisterUsableItem('weed', function(source)
	...
	TriggerClientEvent('t1ger_trafficpolicer:useDrug', xPlayer.source, 'Cannabis', 10)
...
ESX.RegisterUsableItem('meth_pooch', function(source)
	...
	TriggerClientEvent('t1ger_trafficpolicer:useDrug', xPlayer.source, 'Méthanphétamine', 10)
	TriggerClientEvent('esx:showNotification', _source, _U('used_one_meth_pooch'))
end)
...
ESX.RegisterUsableItem('coke_pooch', function(source)
	...
	TriggerClientEvent('t1ger_trafficpolicer:useDrug', xPlayer.source, 'Cocaïne', 10)
	TriggerClientEvent('esx:showNotification', _source, _U('used_one_coke_pooch'))
end)
...
ESX.RegisterUsableItem('opium_pooch', function(source)
	...
	TriggerClientEvent('t1ger_trafficpolicer:useDrug', xPlayer.source, 'Opium', 10)
	TriggerClientEvent('esx:showNotification', _source, _U('used_one_opium_pooch'))
end)
